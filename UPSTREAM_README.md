...
> This file preserves the README documentation from the upstream [Demucs](https://github.com/adefossez/demucs) project. The macOS application overview is available in the main [README.md](README.md).
